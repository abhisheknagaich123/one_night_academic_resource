...
<div class="container-fluid">
    <div class="row border-top px-xl-5">
        <div class="col-lg-3 d-none d-lg-block">
            <a class="d-flex align-items-center justify-content-between bg-secondary w-100 text-decoration-none" data-toggle="collapse" href="#navbar-vertical" style="height: 50px; ">
...
<!--                         <a href="index.php" class="nav-item nav-link">Home</a>
 -->                    </div>
                    <a class="btn btn-primary py-2 px-4 ml-auto d-none d-lg-block" href="admin/index.php" target=_blank>Home</a>
                </div>
            </nav>
        </div>
    </div>
