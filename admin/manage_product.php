...
<div class="content pb-0">
	<div class="animated fadeIn">
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header"><strong>Subject</strong><small> Form Information</small></div>
					<form method="post" enctype="multipart/form-data">
						<div class="card-body card-block">
							...
							<div class="form-group">
								<label for="categories" class=" form-control-label">Subject _Heading</label>
								<input type="text" name="workshop_name" placeholder="Enter Heading  name"
									class="form-control" required value="<?php echo $workshop_name ?>">
							</div>
							...
							<button id="payment-button12" name="submit" type="submit"
